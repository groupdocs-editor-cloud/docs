...
![](editor/images/JWT-Workflow.png)
...
```html 
curl -X GET "https://api.groupdocs.cloud/v2.0/editor/info?FilePath#words/four-pages.docx"
-H "accept: application/json" 
