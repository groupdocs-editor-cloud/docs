...
infoApi = groupdocs_editor_cloud.InfoApi.from_config(configuration)
...
You can find more information at [DockerHub](https://hub.docker.com/repository/docker/groupdocs/editor-cloud).
